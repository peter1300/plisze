...
export function ColorSelector({
  ...
  return (
    <div>
      <h3 className="text-[13px] font-medium tracking-[0.12em] text-mute uppercase">Keretszín</h3>
      <div className="mt-5 grid grid-cols-3 gap-x-4 gap-y-5 sm:grid-cols-6">
        {frameColors.map((color) => {
          ...
          return (
            ...
            >
              <span
                className={`block h-11 w-11 rounded-full ${active ? "ring-2 ring-ink ring-offset-2" : "ring-1 ring-line"}`}
